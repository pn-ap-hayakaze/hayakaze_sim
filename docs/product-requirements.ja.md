...
「v1」は最初にプレイ可能なリリースである。契約と金銭を足す前に、中核ループ（シーズン、ロスター、成長、
...
除外フラグを持ち、枠に数えない。v1では外国人選手は生成されたロスターに存在し枠の対象となる。新規の外国人
